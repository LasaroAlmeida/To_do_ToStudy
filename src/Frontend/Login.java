...
import Backend.Reading_writing;
...
public class Login extends javax.swing.JFrame {
    ...
    ///Valida os dados e vai ou não para a tela do menu
    private void login_Action() {

        if (!Validate_login.validate(name_jTextField1.getText(), new String(password_jPasswordField1.getPassword()))) {
